...
@NgModule({
  ...
  exports: [LayoutComponent, HeaderComponent,FooterComponent,GooglemapComponent,ContactComponent,ProfileComponent,ServiceComponent,AccessComponent,ModalComponent]
})
